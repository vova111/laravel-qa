<template>
  <form @submit.prevent="handleSubmit">
    <div class="form-group">
      ...
      <input type="text" name="title" v-model="title" :class="errorClass('title')" id="question-title">
    ...
    <div class="form-group">
      ...
      <m-editor :body="body" name="question-body">
        <textarea name="body" rows="10" v-model="body" :class="errorClass('body')" id="question-body"></textarea>
